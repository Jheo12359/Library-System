...
<head>
	...
	<?php 
		...
		$sql = "SELECT b.book_id, b.ISBN, b.title, r.return_year,  r.return_month,  r.returned_day, u.user_id, u.username, b.genre FROM rent as r INNER JOIN users as u ON r.user_id = u.user_id INNER JOIN books as b ON b.book_id = r.book_id WHERE r.return_year != 0000";
		...
		<div class="container">
			...
			<form class="form-inline" action="../actions/process.php" method="post">
			  <div class="form-group mx-sm-3 mb-2">
			    <select class="form-control" name="return_filter">
			    	<option>Day</option>
			        <option>Week</option>
			        <option>Month</option>
			        <option>Year</option>
